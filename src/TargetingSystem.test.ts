...
describe("TargetingSystem", () => {
  ...
  it("cycles to next target on cycleTarget input", () => {
    const player = makeAircraft({ x: 0, y: 50, z: 0 });
    player.input = { pitch: 0, roll: 0, yaw: 0, throttle: 0, fire: false, cycleTarget: true, lockOn: false, cycleWeapon: false, deployCountermeasure: false };
    ...
    player.input = { pitch: 0, roll: 0, yaw: 0, throttle: 0, fire: false, cycleTarget: false, lockOn: false, cycleWeapon: false, deployCountermeasure: false };
    system.update(player as never, [e1 as never, e2 as never], null as never);
    player.input = { pitch: 0, roll: 0, yaw: 0, throttle: 0, fire: false, cycleTarget: true, lockOn: false, cycleWeapon: false, deployCountermeasure: false };
    system.update(player as never, [e1 as never, e2 as never], null as never);
